# MINIMACY Example: HTTP Time server

This program demonstrates how to:
- implement a simple http server
- manipulate JSON data
- create a bitmap and write text in it
- create a bitmap and draw graphics in it
- encode a bitmap as png data

Documentation is here [HTTP Time server](https://minimacy.net/book/#/page/page:1383,tm:0)
